...
/// Allows for overwriting values with user define macro
/// used as a way to change fxp lengths values without changing source code
#ifndef DBG_OPT
// Values optimized by genetic algorithm in Matlab
